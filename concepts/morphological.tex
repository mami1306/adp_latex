...
\begin{enumerate}
	\item \textbf{FMPS}\\
	\(70 kPa \leq P_\textit{Total, Messger\"{a}teeinlass} \leq 103 kPa\)\\
	\(V_\textit{Aerosolauslass} = 3,34 \frac{m}{s}\)\\
	\(70 kPa \leq P_\textit{Betrieb} \leq 103 kPa\)\\
	\item \textbf{UCPC}\\
	\(75 kPa \leq P_\textit{Total, Messger\"{a}teeinlass} \leq 105 kPa\)\\
	\(V_\textit{Aerosolauslass} = 0,5 \frac{m}{s}\)\\
	\(75 kPa \leq P_\textit{Betrieb} \leq 105 kPa\)\\
	\item \textbf{APS}\\
	\(40 kPa \leq P_\textit{Total, Messger\"{a}teeinlass} \leq 103 kPa\)\\
	\(V_\textit{Aerosolauslass} = 1,66 \frac{m}{s}\)\\
	\(40 kPa \leq P_\textit{Betrieb} \leq 103 kPa\)
\end{enumerate} 
