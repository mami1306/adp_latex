...
%======================================================
\newcommand{\adpTitle}{Entwicklung eines Konzepts und Konstruktion einer Versuchseinrichtung zur zeitlich synchronisierten Generierung von Partikel-Testsignalen
\xspace}
\newcommand{\adpThesisType}{Advanced Design Project\xspace} 
\newcommand{\adpID}{\xspace}
\newcommand{\adpName}{Alexander Sonnleitner, Dinh-Van Vo, Kim-Khanh Vo, Gia Thi Ngo, Felix Sternkopf\xspace}
\newcommand{\adpSubmissionDate}{13. Februar 2018\xspace}
\newcommand{\adpGutachter}{Gutachter: Prof. Dr. rer. nat. Hermann Winner\xspace}
\newcommand{\adpBetreuer}{Betreuer: M.Sc. Hartmut Niemann\xspace}
\newcommand{\adpExternerBetreuer}{\xspace}
...
\hypersetup{%
    ...
    pdftitle={\adpTitle, \adpThesisType, \adpID},%
    pdfauthor={\adpName, FZD, TU Darmstadt},%
    pdfsubject={},%
    pdfkeywords={},%
    pdfcreator={},%
    pdfproducer={}%
...
\subsubtitle{\adpName \\ \adpID}
%\setinstitutionlogo[height]{gfx/sim_logo}
\institution{\raggedleft Fachbereich Maschinenbau\\[\baselineskip]%
	Fachgebiet Fahrzeugtechnik und Dynamik \\%(SIM)
...
\uppertitleback{%
	...
	\adpThesisType \\%
	\adpID \\[\baselineskip]%
	Eingereicht von \adpName \\%
	Tag der Einreichung: \adpSubmissionDate \\[\baselineskip]%
	\adpGutachter \\%
	\adpBetreuer \\%
	\adpExternerBetreuer%
}
